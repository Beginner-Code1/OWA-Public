...
user_menu = st.sidebar.radio(
    'Select an Option',
    ('Medal Tally', 'Overall Analysis', 'Country-wise Anaylsis', 'Athlete wise Analysis')
)
...
if user_menu == 'Country-wise Anaylsis':
    st.sidebar.title('Country-wise Anaylsis')
...
if user_menu == 'Athlete wise Analysis':
    ...
    for sport in famous_sports:
        ...
        if not temp_df.empty and not temp_df[temp_df['Medal'] == 'Gold']['Age'].dropna().empty:
